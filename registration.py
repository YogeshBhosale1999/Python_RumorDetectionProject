...
# Function to validate and store the data on click of Register button
def insert():
    fname = Fullname.get()
    addr = address.get()
    un = username.get()
...
# Create a PhotoImage object & Set as background with the help of Label widget
background_image = ImageTk.PhotoImage(image2)

background_label = tk.Label(window, image=background_image)
# Set image to Label object
background_label.image = background_image

background_label.place(x=0, y=0)  # , relwidth=1, relheight=1)

# Create Registration Form Label
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#192841", fg="white")
l1.place(x=190, y=50)


# Create a Label of Full-name & entry box (text box) for it
