...
# fn = ""
##############################################+=============================================================
# Create a main window (on root pane) and configure it
root = tk.Tk()
root.configure(background="brown")
# root.geometry("1300x700")

# Fetch width and height of the console
w, h = root.winfo_screenwidth(), root.winfo_screenheight()
# Configured the fecthed width and height
root.geometry("%dx%d+0+0" % (w, h))
root.title("Rumour Detection  System")
...
#
label_l1 = tk.Label(root, text="Rumour Detection  System",font=("Times New Roman", 35, 'bold'),
